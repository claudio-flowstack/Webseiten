/**
 * @baustein WebGL Shader Background
 * @zweck Animierter WebGL Hintergrund mit Lichtlinien-Effekt (RGB Chromatic Aberration)
 * @geeignet-fuer Full-Screen Backgrounds, Section-Divider, Behind-Content Effekte
 * @stil Schwarzer Hintergrund mit farbigen Lichtlinien, subtile Animation
 * @props Keine (fixed fullscreen canvas)
 */

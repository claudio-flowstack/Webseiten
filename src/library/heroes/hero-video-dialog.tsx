/**
 * @baustein Hero Video Dialog
 * @zweck Video-Thumbnail mit animiertem Play-Button, öffnet Video-Modal mit 8 Animations-Varianten
 * @geeignet-fuer Produkt-Demos, Explainer Videos, SaaS Landing Pages, Portfolio
 * @stil Play-Button mit Gradient-Glow, Modal mit Backdrop-Blur, 8 Animationen
 * @props videoSrc (YouTube/Vimeo embed URL), thumbnailSrc, animationStyle, className
 */

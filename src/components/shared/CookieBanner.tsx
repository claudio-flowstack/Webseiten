        ...
        <div className="fixed bottom-4 left-4 right-4 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:w-full sm:max-w-2xl z-50">
          <div className="bg-[#0a0a0e]/95 backdrop-blur-xl border border-gray-800/50 shadow-2xl rounded-2xl p-6 flex flex-col gap-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <Link to="/datenschutz" className="text-cyan-300 hover:underline">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-cyan-400 to-cyan-500 hover:shadow-lg hover:shadow-cyan-400/25 text-white rounded-xl px-5 py-2.5 text-sm font-semibold transition-all"
              >
                Alle akzeptieren
              </button>
              <button
          ...
          <div className="bg-[#0a0a0e] border border-gray-800/50 rounded-2xl shadow-2xl max-w-lg w-full p-6 sm:p-8 relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-4 bg-cyan-400/10 border border-cyan-400/20 rounded-xl">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="w-11 h-6 bg-cyan-400 rounded-full flex items-center justify-end px-1">
                ...
                <div className="flex items-center justify-between p-4 border border-gray-800/50 rounded-xl hover:bg-gray-900/50 transition-colors">
                  ...
                  <button
                    ...
                    className={`w-11 h-6 rounded-full flex items-center transition-colors duration-300 ${
                      cookieSettings.analytics ? 'bg-cyan-400 justify-end' : 'bg-gray-700 justify-start'
                    }`}
                  >
                ...
                <div className="flex items-center justify-between p-4 border border-gray-800/50 rounded-xl hover:bg-gray-900/50 transition-colors">
                  ...
                  <button
                    ...
                    className={`w-11 h-6 rounded-full flex items-center transition-colors duration-300 ${
                      cookieSettings.marketing ? 'bg-cyan-400 justify-end' : 'bg-gray-700 justify-start'
                    }`}
                  >
                    <div className="w-4 h-4 bg-white rounded-full mx-1 shadow-sm"></div>
                  </button>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-cyan-400 to-cyan-500 hover:shadow-lg hover:shadow-cyan-400/25 text-white rounded-xl px-5 py-3 text-sm font-semibold transition-all"
              >
                Auswahl speichern
              </button>
              <button

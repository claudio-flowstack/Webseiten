...
// ============================================================================
// HERO COMPONENT (default export for lazy loading)
// ============================================================================
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <Beams
          beamWidth={2.5} beamHeight={18} beamNumber={15}
          lightColor="#ffffff" speed={2.5} noiseIntensity={2}
          scale={0.15} rotation={43}
        />
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-8 text-white/80 sm:text-xl lg:text-2xl max-w-3xl mx-auto">
              80% deines Fulfillments ist Wiederholung. Strategie, Texte, Kampagnen, Reports. Flowstack ersetzt das komplett durch KI. Für 1/1000 der Kosten eines Mitarbeiters. Du machst nur noch eins: Freigeben.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <a href="/demo/kostenlose-beratung" className="group relative overflow-hidden rounded-full inline-flex items-center justify-center font-semibold transition-all px-8 py-6 text-lg bg-white text-black hover:bg-gray-100 shadow-2xl shadow-white/25">
              ...
              <a href="#prozess" className="group relative overflow-hidden rounded-full inline-flex items-center justify-center font-semibold transition-all px-8 py-6 text-lg border border-white/20 bg-transparent backdrop-blur-xl text-white hover:bg-white/10 hover:border-white/30">
                <span className="relative z-10 flex items-center">So funktioniert's</span>
              </a>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Weniger Personalkosten</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">47</div>
                <div className="text-white/60 text-sm">Automatisierte Schritte</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-2">5 Min</div>
                <div className="text-white/60 text-sm">Pro Kunden-Setup</div>
              </div>
            </div>
          </div>
        </div>

      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col gap-4">
          ...
          <div className="pt-12 w-full">
            ...
            >
              <div
                className="bg-purple-400/30 h-full w-1 absolute z-20 top-0 -ml-1 select-none"
                style={{ left: inset + "%" }}
              >
                <button
                  className="bg-purple-400/30 backdrop-blur-sm rounded hover:scale-110 transition-all w-5 h-10 select-none -translate-y-1/2 absolute top-1/2 -ml-2 z-30 cursor-ew-resize flex justify-center items-center"
                  onTouchStart={(e) => {
                    setIsMouseDown(true)
